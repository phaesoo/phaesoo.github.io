...
# Table of Contents
2편에서는 Kong Custom plugin 제작 및 Kubernetes 환경에 배포하고 테스트하는 과정까지 다뤄볼 예정이다.
1. [Custom plugin 구현 Workflow](#custom-plugin-구현-workflow)
1. [Our service architecture](#our-service-architecture)
